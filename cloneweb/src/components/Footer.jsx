      ...
      <div className='max-w-[100%] mt-[100px] lg:h-[460px] ps:h-[1124px] bg-gray-200'>
        <div className='max-w-[1500px] mx-auto h-[430px] relative top-[30px]'>
          <div className='grid lg:grid-cols-4 md:grid-cols-1'>
            <div className=''>
              <h1 className='font-semibold text-xl lg:m-0 ps:ml-3'>Support</h1>
              <div className='text-ps lg:pt-[20px] ps:pt-[10px] lg:leading-[45px] ps:leading-[35px] grid lg:grid-cols-1 md:grid-cols-3 lg:m-0 ps:ml-3'>
                <div>Help center</div>
                <div>Air cover</div>
            ...
            <div className='lg:pt-0 ps:pt-10 lg:m-0 ps:ml-3'>
              <h1 className='font-semibold text-xl'>Community</h1>
              <div className='text-ps lg:pt-[20px] ps:pt-[10px] lg:leading-[45px] ps:leading-[35px] grid lg:grid-cols-1 md:grid-cols-2'>
            ...
            <div className='lg:pt-0 ps:pt-10 lg:m-0 ps:ml-3'>
              ...
              <div className='text-ps lg:pt-[20px] ps:pt-[10px] lg:leading-[45px] ps:leading-[35px] grid lg:grid-cols-1 md:grid-cols-3'>
