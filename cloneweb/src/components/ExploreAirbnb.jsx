  ...
  return (
    <>
      <div className='max-w-[1500px] mx-auto pt-[150px]'>
          ...
          <div className='max-w-[1000px] text-xl grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 lg:gap-10 sm:gap-9 md:gap-10 pt-3'>
            <div className='flex border-solid border-2 lg:shadow-2xl sm:shadow-xl lg:m-0 sm:ml-2 sm:mr-[50px]'>
              <img className='lg:h-[95px] sm:h-[70px]' src={hotels} alt="" />
              <h1 className='relative lg:top-[30px] lg:left-[15px] sm:top-[18px] sm:left-[10px]'>Hotels</h1>
            </div>
            <div className='flex border-solid border-2 lg:shadow-2xl sm:shadow-xl lg:m-0 sm:ml-2 sm:mr-[50px]'>
              <img className='lg:h-[95px] sm:h-[70px]' src={experience} alt="" />
              <h1 className='relative lg:top-[30px] lg:left-[15px] sm:top-[18px] sm:left-[10px]'>Experience</h1>
            </div>
            <div className='flex border-solid border-2 lg:shadow-2xl sm:shadow-xl lg:m-0 sm:ml-2 sm:mr-[50px]'>
              <img className='lg:h-[95px] sm:h-[70px]' src={restaurants} alt="" />
