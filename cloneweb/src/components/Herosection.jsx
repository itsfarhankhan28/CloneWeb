    ...
    <>
        <div className='max-w-[1500px] mx-auto '>
            <div className='md:text-center lg:text-left sm:text-center lg:leading-[150px]'>
              ...
              <h2 className='lg:text-6xl lg:m-0 sm:text-4xl lg:leading-[65px] sm:leading-[45px] font-semibold leading-[65px]'>Book unique homes and <br />  experience a city like a local.</h2>
            </div>
        </div>
