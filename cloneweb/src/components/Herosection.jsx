    ...
    <>
        <div className='max-w-[1500px] mx-auto '>
            <div className='md:text-center lg:text-left sm:text-center lg:leading-[150px]'>
              ...
              <h2 className='lg:text-6xl lg:m-0 sm:text-4xl lg:leading-[65px] sm:leading-[43px] font-semibold leading-[65px]'>Book unique homes and <br />  experience a city like a local.</h2>
            </div>
        </div>
        <div className='lg:max-w-[1500px] lg:mx-auto sm:mx-2 lg:h-[70px] sm:h-[50px] relative top-[53px] shadow-xl flex'>
            <div className='lg:pt-[18px] lg:pl-[15px] lg:text-4xl sm:text-xl sm:pt-[5px]'>
